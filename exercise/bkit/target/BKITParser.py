...
class BKITParser ( Parser ):
    ...
    class MptypeContext(ParserRuleContext):
        ...
        def VOIDTYPE(self):
            return self.getToken(BKITParser.VOIDTYPE, 0)
    ...
    def mptype(self):
        ...
        try:
            ...
            self.state = 21
            _la = self._input.LA(1)
            if not(_la==BKITParser.INTTYPE or _la==BKITParser.VOIDTYPE):
    ...
    class BodyContext(ParserRuleContext):
        ...
        def funcall(self):
            return self.getTypedRuleContext(BKITParser.FuncallContext,0)
    ...
    class FuncallContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return BKITParser.RULE_funcall
    ...
    def funcall(self):
        ...
        localctx = BKITParser.FuncallContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if _la==BKITParser.ID or _la==BKITParser.INTLIT:
                self.state = 32
                self.exp()
